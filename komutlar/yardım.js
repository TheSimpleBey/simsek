...
exports.run = (client, message, args) => {
    const embed = new Discord.RichEmbed()
        ...
        .addField(`» Linkler`, `[Bot Davet Linki](https://discord.com/api/oauth2/authorize?client_id=727855467585601557&permissions=8&scope=bot) **|** [Destek Sunucusu](https://discord.gg/EPCu35V) **|** [Web Sitemiz](https://linlordscode.glitch.me/)`)
