...
db.set(`Şimşek Bot`,`Bu oyunu oynadığınız botun ismi.`)
...
//Amil <3 ///////////////////
      var kelimeler = ['Klostrofobi','Türkçe','Domates','Otel','Söğüt','Veteriner','Şimşek Bot','Rythm','Magnum','Lüksemburg','Deve'];
